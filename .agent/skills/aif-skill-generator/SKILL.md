...
2. LEVEL 1 — Run automated scan:
   $PYTHON ~/.agent/skills/aif-skill-generator/scripts/security-scan.py <skill-path>
3. Check exit code:
...
2. **LEVEL 1** — Run automated scanner:
   ```bash
   $PYTHON ~/.agent/skills/aif-skill-generator/scripts/security-scan.py <path>
   ```
...
```bash
$PYTHON ~/.agent/skills/aif-skill-generator/scripts/security-scan.py ./skill-name/
```
